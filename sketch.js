...
"../assets/Run__009.png");
 ...
 ninjaJump = loadAnimation(
"../assets/Jump__000.png",
"../assets/Jump__001.png",
"../assets/Jump__002.png",
"../assets/Jump__003.png",
"../assets/Jump__004.png",
"../assets/Jump__005.png",
"../assets/Jump__006.png",
"../assets/Jump__007.png",
"../assets/Jump__008.png",
"../assets/Jump__009.png");

 ninjaDead = loadAnimation(
"../assets/Dead0.png",
"../assets/Dead1.png",
"../assets/Dead2.png",
"../assets/Dead3.png",
...
"../assets/groundGrande.png");

 ghostImage = loadAnimation(
"../assets/ghost0.png",
"../assets/ghost1.png",
"../assets/ghost3.png",
"../assets/ghost4.png",
...
soundDead = loadSound(
"../assets/dead.mp3");
soundForce = loadSound(
"../assets/The_Force.mp3");
soundJump = loadSound(
"../assets/jump.mp3");
soundLaser = loadSound(
"../assets/laser.mp3");
...
function setup() {
  ...
  invisibleGround = createSprite(width/2, height - height*0.2, width,
height*0.06);
...
function draw() {
  ...
  if(gameState === END){
    ...
    soundDead.play();
    soundDead.playMode("restart");
    setTimeout(function(){
      ninja.animation.sFtop();
    }, 3000)
